function param_imaging = util_set_param_imaging(param_general, param_algo, imDims, runID)
    ...
    switch param_general.algorithm
        case 'airi'
            subFolerName = ['AIRI_ID_',num2str(runID), ...
                '_heuScale_', num2str(param_algo.heuNoiseScale), ...
                '_maxItr_',num2str(param_algo.imMaxItr)];
        case 'cairi'
            subFolerName = ['cAIRI_ID_',num2str(runID), ...
                '_heuScale_', num2str(param_algo.heuNoiseScale), ...
                '_maxItr_',num2str(param_algo.imMaxItr)];
        case 'upnp-bm3d'
            subFolerName = ['uPnP-BM3D_ID_',num2str(runID), ...
                '_heuScale_', num2str(param_algo.heuNoiseScale), ...
                '_maxItr_',num2str(param_algo.imMaxItr)];
        case 'cpnp-bm3d'
            subFolerName = ['cPnP-BM3D_ID_',num2str(runID), ...
                '_heuScale_', num2str(param_algo.heuNoiseScale), ...
                '_maxItr_',num2str(param_algo.imMaxItr)];
    end
    % set full path
